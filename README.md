...
claude --plugin-dir /path/to/knowledge-graph/plugins/knowledge-graph
```
...
/plugin marketplace update knowledge-graph  # Update to latest version
/plugin disable knowledge-graph@knowledge-graph  # Disable without uninstalling
/plugin enable knowledge-graph@knowledge-graph   # Re-enable
...
└── plugins/knowledge-graph/           ← Plugin root
...
/plugin marketplace update knowledge-graph  # 更新到最新版本
/plugin disable knowledge-graph@knowledge-graph  # 禁用（不卸载）
/plugin enable knowledge-graph@knowledge-graph   # 重新启用
