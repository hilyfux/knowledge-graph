...
生成 `.claude/skills/knowledge-graph/data/knowledge-index.md`，极致精简：
...
若已存在但不含 `@.claude/skills/knowledge-graph/data/knowledge-index.md`，在末尾追加。
...
3. 删除 `.claude/skills/knowledge-graph/data/graph-infer.json`（临时缓存）
4. 重新生成 `.claude/skills/knowledge-graph/data/knowledge-index.md`（同 init 步骤 6 的格式）
